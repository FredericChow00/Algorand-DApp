...
async function run(runtimeEnv, deployer) {
    ...
    await Promise.all(assets.map(async (asset) => {
        ...
        const metadata = {
            ...
            properties: {
                file_url: `https://gateway.pinata.cloud/ipfs/${result.IpfsHash}/Users/Frederic Chow/Desktop/Algorand/Assessment/Fundamentals/arc3-nft-FredericChow00/assets/nft/${asset.file}`,
